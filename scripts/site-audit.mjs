...
for(const file of pages){
 ...
 for(const token of ['rel="canonical"','<h1>','Frequently asked questions','application/ld+json','id="root"','data-tool=','type="module" src="/index.tsx"']) if(!html.includes(token)) throw new Error(`${file}: missing ${token}`);
...
console.log(`Spreadsheet complete on-page SEO audit passed for ${pages.length} pages.`);
